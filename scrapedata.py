...
def main():
    ...
    # Search for users in Barcelona with >500 followers
    ...
    with open('README.md', 'w') as f:
        f.write(f"""# GitHub Users in Barcelona

This repository contains data about GitHub users in Barcelona with over 100 followers and their repositories.

## Files

1. `users.csv`: Contains information about {len(users)} GitHub users in Barcelona with over 100 followers
